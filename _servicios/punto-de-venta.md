    ...
    <div class="row">
      <div class="col-lg-12 mb-3">
          <div class="box featured wow fadeInUp h-100 d-flex flex-column justify-content-center">
              <h3 style="text-align:center;">Punto de venta</h3>
              <hr width="25%" color="#6699FF" size="4">
              <h5 style="text-align:center;">$16,000.00<sup><small style="font-size: 10px;">[1]</small></sup> MXN</h5>
              <p style="text-align:center;"><span>&#9782;</span>Sistema punto de venta (POS)</p>
              <p style="text-align:center;"><span>&#9782;</span>Terminal bancaria (CLIP)</p>
              <p style="text-align:center;"><span>&#9782;</span>Tableta/Monitor</p>
              <p style="text-align:center;"><span>&#9782;</span>Caja registradora</p>
              <hr width="25%" color="#6699FF" size="4">
          </div>
      </div>
    </div>
